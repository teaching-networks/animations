...
/// Event emitted when the model loses its selection.
class UnselectEvent implements ComboBoxModelEvent {
  @override
  ComboBoxModelEventType get type => ComboBoxModelEventType.UNSELECTED;
}
